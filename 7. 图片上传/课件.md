# 26 · 图片上传（Figma 资产 + 用户上传）

> **前置：** [25. figma处理整体设计](../25.%20figma处理整体设计/课件.md)、[23. 配置figma mcp server](../23.%20配置figma%20mcp%20server/课件.md)  
> **配套代码：**  
...
**上一节：** [25. figma处理整体设计](../25.%20figma处理整体设计/课件.md)  
**下一节：** 回顾 [02. 后端架构总课件](../课件.md) 或 [04. 多Agent与适配器](../04.%20多Agent与适配器/课件.md)
