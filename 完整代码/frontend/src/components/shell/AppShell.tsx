...
export function AppShell({ children }: AppShellProps) {
  ...
  return (
    <div className="flex h-screen w-screen flex-col overflow-hidden bg-[var(--background)]">
      {/* 顶部 Header */}
      <header className="relative flex h-14 shrink-0 items-center justify-between border-b border-[var(--lab-border)] bg-gradient-to-r from-white via-[#fafff5] to-[#fff8f0] px-4 backdrop-blur-sm">
        ...
        <div className="relative" ref={dropdownRef}>
          <button
            ...
            className="relative flex h-8 w-8 items-center justify-center overflow-hidden rounded-full ring-2 ring-[var(--lab-green)]/25 shadow-sm transition-all hover:ring-[var(--lab-orange)]/40 hover:shadow-md active:scale-95"
          >
            <Image
              src="/avatar.gif"
              alt="User Avatar"
          ...
          {isDropdownOpen && (
            <div className="absolute right-0 top-full mt-2 w-48 origin-top-right animate-in fade-in zoom-in-95 duration-200 rounded-xl border border-[var(--lab-border)] bg-white p-1 shadow-lg ring-1 ring-[var(--lab-green)]/10 focus:outline-none z-50">
              <button
